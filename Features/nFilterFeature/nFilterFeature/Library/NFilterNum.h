...
@interface NFilterNum : UIViewController <NFilterToolbarDelegate, NFilterToolbar2Delegate> {
...
@property (nonatomic, strong) NSString *deleteBtnAccessibilityTxt;      // 시리얼키패드 삭제 버튼 대체 텍스트 설정
@property (nonatomic, strong) NSString *emptyBtnAccessibilityTxt;       // 시리얼키패드 Empty 버튼 대체 텍스트 설정
