...
public struct MetSPMTest: ButtonStyle {
    ...
    private var buttonColor: Color {
        switch colorScheme {
        case .light:
            return appearance.lightColor
        case .dark:
            return appearance.darkColor
        @unknown default:
            return appearance.lightColor
        }
    }
    ...
    private func borderColor(_ configuration: Self.Configuration) -> Color {
        switch colorScheme {
        case .light:
            return Color.white.opacity(configuration.isPressed ? 0.24 : 0.1)
        case .dark:
            return Color.white.opacity(configuration.isPressed ? 0.07 : 0.05)
        @unknown default:
            return Color.white.opacity(configuration.isPressed ? 0.24 : 0.1)
        }
    }
